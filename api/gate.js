...
const PAGES = {
  ...
  '/countries.html':                       { offer: '_offer/countries.html',        white: '_white/index.html' },
  '/what-is-idp.html':                     { offer: '_offer/what-is-idp.html',      white: '_white/index.html' },
  ...
  '/about-us.html':                        { offer: '_offer/about-us.html',        white: '_white/index.html' },
  '/contact-us.html':                      { offer: '_offer/contact-us.html',      white: '_white/index.html' },
  '/cookie-policy.html':                   { offer: '_offer/cookie-policy.html',   white: '_white/index.html' },
  '/legal-disclaimer.html':                { offer: '_offer/legal-disclaimer.html', white: '_white/index.html' },
  '/privacy-policy.html':                  { offer: '_offer/privacy-policy.html', white: '_white/index.html' },
  '/refund-return-policy.html':            { offer: '_offer/refund-return-policy.html', white: '_white/index.html' },
  '/shipping-policy.html':                 { offer: '_offer/shipping-policy.html', white: '_white/index.html' },
  '/terms-of-service.html':                { offer: '_offer/terms-of-service.html', white: '_white/index.html' },
  '/acceptable-use-policy.html':           { offer: '_offer/acceptable-use-policy.html', white: '_white/index.html' },
  '/accessibility-statement.html':         { offer: '_offer/accessibility-statement.html', white: '_white/index.html' },
  '/dmca-and-intellectual-property-policy.html': { offer: '_offer/dmca-and-intellectual-property-policy.html', white: '_white/index.html' },
  '/payment-policy.html':                  { offer: '_offer/payment-policy.html', white: '_white/index.html' },
  '/checkout.html':                        { offer: '_offer/checkout.html',       white: '_white/index.html' },
  '/payment.html':                         { offer: '_offer/payment.html',        white: '_white/index.html' },
  '/pricing.html':                         { offer: '_offer/pricing.html',        white: '_white/index.html' },
  '/faq.html':                             { offer: '_offer/faq.html',            white: '_white/index.html' },
  '/track-order.html':                     { offer: '_offer/track-order.html',    white: '_white/index.html' },
  '/upload-photos.html':                   { offer: '_offer/upload-photos.html',  white: '_white/index.html' },
  '/thank-you.html':                       { offer: '_offer/thank-you.html',      white: '_white/index.html' },
};
...
<title>FirstIDP — Back shortly</title>
<style>
...
<body><div class="card">
  ...
  <p>FirstIDP is doing a quick update. Please check back in a few minutes.</p>
</div></body></html>`;
